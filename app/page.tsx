    ...
    <div>
      ...
      <section className="h-[150vh] bg-[#0f172a] pl-[10%] pr-[10%] pt-40">
        <div className="mx-auto place-self-center text-center">
          ...
          <div className="grid max-w-full grid-cols-3 gap-4 sm:grid-cols-1 md:grid-cols-3">
            <div className="col-span-3 mt-10 flex h-[50vh] max-w-full rounded-xl border border-gray-200 bg-transparent shadow dark:border-gray-700 dark:bg-gray-800">
              <div
            ...
            <div className="mt-10 flex h-[50vh] max-w-full rounded-xl border border-gray-200 bg-transparent p-6 shadow dark:border-gray-700 dark:bg-gray-800"></div>
            <div className="mt-10 flex h-[50vh] max-w-full rounded-xl border border-gray-200 bg-transparent p-6 shadow dark:border-gray-700 dark:bg-gray-800"></div>
            <div className="mt-10 flex h-[50vh] max-w-full rounded-xl border border-gray-200 bg-transparent p-6 shadow dark:border-gray-700 dark:bg-gray-800"></div>
          </div>
        </div>
      ...
      <section className="h-[50vh] bg-[#0f172a] pl-[10%] pr-[10%] pt-40">
        <div className="mx-auto place-self-center text-center">
          <div className="mb-4 text-center text-4xl font-extrabold capitalize leading-none tracking-tight text-white md:text-4xl xl:text-5xl">
