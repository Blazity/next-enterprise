...
export { Root, Close, Trigger, Portal, Overlay, Content, Header, Footer, Title, Description, Root as Sheet, type SheetProps, Close as SheetClose, type CloseProps, Trigger as SheetTrigger, type TriggerProps, Portal as SheetPortal, type SheetPortalProps, Overlay as SheetOverlay, type SheetOverlayProps, Content as SheetContent, type SheetContentProps, Header as SheetHeader, type SheetHeaderProps, Footer as SheetFooter, type SheetFooterProps, Title as SheetTitle, type SheetTitleProps, Description as SheetDescription, type SheetDescriptionProps };
