...
export function ToastContainer() {
  ...
  return (
    <div className="fixed bottom-24 md:bottom-20 left-1/2 -translate-x-1/2 md:left-auto md:right-6 md:translate-x-0 z-[200] flex flex-col gap-3 pointer-events-none w-[90%] md:w-auto">
      {toasts.map((toast) => (
        <div
          key={toast.id}
          className={cn(
